...
def get_config_hyperopt(model_name):
    ...
    model_spaces = {
        ...
        "GradientBoostingRegressor": {"model__n_estimators": (100 + hp.randint("model__n_estimators", 900)),
                                      "model__learning_rate": hp.loguniform('model__learning_rate', np.log(0.001),
                                                                            np.log(1))},
